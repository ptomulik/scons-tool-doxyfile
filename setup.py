...
class develop(setuptools.command.develop.develop):
    def _make_symlinks(self, sources):
        here = os.path.abspath(os.path.dirname(__file__))
        subdir = os.path.join(here, 'sconstool', 'doxyfile')
...
setup(
        name='scons-tool-doxyfile',
        version=about['__version__'],
        package_dir={'sconstool.doxyfile': '.'},
        packages=['sconstool.doxyfile'],
        namespace_packages=['sconstool'],
        description='SCons tool to generate Doxyfile for Doxygen',
        long_description=readme,
        long_description_content_type='text/x-rst',
        url='https://github.com/ptomulik/scons-tool-doxyfile',
